  ...
  describe "#conversations" do
    let(:conversation_id) do
      VCR.use_cassette("#{cassette} setup") do
        ShopifAi::Client.new.conversations.create(parameters: {})["id"]
      end
    end
    let(:item_id) do
      VCR.use_cassette("#{cassette} item setup") do
        ShopifAi::Client.new.conversations.create_items(
    ...
    describe "#retrieve" do
      ...
      let(:response) { ShopifAi::Client.new.conversations.retrieve(id: conversation_id) }
    ...
    describe "#create" do
      ...
      let(:response) do
        ShopifAi::Client.new.conversations.create(parameters: {})
      end
      ...
      context "with parameters" do
        let(:response) do
          ShopifAi::Client.new.conversations.create(
    ...
    describe "#modify" do
      ...
      let(:response) do
        ShopifAi::Client.new.conversations.modify(
          id: conversation_id,
    ...
    describe "#delete" do
      ...
      let(:response) do
        ShopifAi::Client.new.conversations.delete(id: conversation_id)
      end
    ...
    describe "#list_items" do
      ...
      let(:response) do
        ShopifAi::Client.new.conversations.list_items(conversation_id: conversation_id)
      end
      ...
      context "with parameters" do
        let(:response) do
          ShopifAi::Client.new.conversations.list_items(
            conversation_id: conversation_id,
            parameters: { limit: 5 }
          )
        end
    ...
    describe "#get_item" do
      ...
      let(:response) do
        ShopifAi::Client.new.conversations.get_item(
          conversation_id: conversation_id,
          item_id: item_id
        )
      end
