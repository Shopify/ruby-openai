  ...
  describe "#batches" do
    ...
    let(:batch_id) do
      VCR.use_cassette("#{cassette} setup") do
        ShopifAi::Client.new.batches.create(
          parameters: {
    ...
    describe "#list", :vcr do
      ...
      let(:limit) { 10 }
      let(:response) { ShopifAi::Client.new.batches.list }
      ...
      it "supports after and limit parameters" do
        VCR.use_cassette(cassette) do
          response = ShopifAi::Client.new.batches.list(parameters: {
    ...
    describe "#retrieve" do
      ...
      let(:response) { ShopifAi::Client.new.batches.retrieve(id: batch_id) }
    ...
    describe "#create" do
      ...
      let(:response) do
        ShopifAi::Client.new.batches.create(parameters: {
                                            input_file_id: input_file_id,
                                            endpoint: "/v1/chat/completions",
                                            completion_window: "24h"
                                          })
    ...
    describe "#cancel" do
      ...
      let(:response) do
        ShopifAi::Client.new.batches.cancel(id: batch_id)
      end
