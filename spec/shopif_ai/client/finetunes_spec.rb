RSpec.describe ShopifAi::Client do
  describe "#finetunes", :vcr do
    ...
    describe "#list" do
      ...
      let(:response) { ShopifAi::Client.new.finetunes.list }
    ...
    describe "#create" do
      ...
      let(:upload_id) do
        response = VCR.use_cassette("finetunes files upload") do
          ShopifAi::Client.new.files.upload(parameters: { file: file, purpose: "fine-tune" })
        end
        response["id"]
      end
      ...
      let(:response) do
        VCR.use_cassette("#{cassette} create") do
          ShopifAi::Client.new.finetunes.create(
            parameters: {
    ...
    describe "#retrieve" do
      ...
      let(:response) { ShopifAi::Client.new.finetunes.retrieve(id: 123) }
    ...
    describe "#cancel" do
      ...
      let(:response) { ShopifAi::Client.new.finetunes.cancel(id: 123) }
    ...
    describe "#list_events" do
      ...
      let(:response) { ShopifAi::Client.new.finetunes.list_events(id: 123) }
