RSpec.describe ShopifAi::Client do
  describe "#messages" do
    ...
    describe "#retrieve" do
      ...
      let(:response) do
        ShopifAi::Client.new.messages.retrieve(thread_id: thread_id, id: message_id)
      end
    ...
    describe "#list" do
      ...
      let(:response) do
        ShopifAi::Client.new.messages.list(thread_id: thread_id, parameters: { order: "asc" })
      end
    ...
    describe "#modify" do
      ...
      let(:response) do
        ShopifAi::Client.new.messages.modify(
          id: message_id,
          thread_id: thread_id,
          parameters: {
    ...
    describe "#delete" do
      ...
      let(:response) do
        ShopifAi::Client.new.messages.delete(thread_id: thread_id, id: message_id)
      end
