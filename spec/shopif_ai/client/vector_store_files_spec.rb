  ...
  describe "#vector_store_files" do
    ...
    let(:vector_store_file_id) do
      VCR.use_cassette("#{cassette} vector_store_file setup") do
        ShopifAi::Client.new.vector_store_files.create(
    ...
    describe "#list" do
      ...
      let(:response) do
        ShopifAi::Client.new.vector_store_files.list(vector_store_id: vector_store_id)
      end
    ...
    describe "#retrieve" do
      ...
      let(:response) do
        ShopifAi::Client.new.vector_store_files.retrieve(vector_store_id: vector_store_id,
    ...
    describe "#delete" do
      ...
      let(:response) do
        ShopifAi::Client.new.vector_store_files.delete(vector_store_id: vector_store_id,
                                                     id: vector_store_file_id)
      end
