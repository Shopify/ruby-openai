RSpec.describe ShopifAi::Client do
  describe "#responses" do
    describe "#create", :vcr do
      ...
      let(:response) do
        ShopifAi::Client.new({ uri_base: uri_base }).responses.create(
    ...
    describe "#retrieve" do
      ...
      let(:response_id) do
        VCR.use_cassette("responses retrieve setup") do
          ShopifAi::Client.new.responses.create(
            parameters: {
              model: model,
      ...
      let(:response) { ShopifAi::Client.new.responses.retrieve(response_id: response_id) }
    ...
    describe "#delete" do
      ...
      let(:response) { ShopifAi::Client.new.responses.delete(response_id: response_id) }
    ...
    describe "#input_items" do
      ...
      let(:response) { ShopifAi::Client.new.responses.input_items(response_id: response_id) }
