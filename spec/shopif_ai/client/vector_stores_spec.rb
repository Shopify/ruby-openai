RSpec.describe ShopifAi::Client do
  describe "#vector_stores" do
    ...
    describe "#list" do
      ...
      let(:response) do
        ShopifAi::Client.new.vector_stores.list(parameters: {})
      end
    ...
    describe "#retrieve" do
      ...
      let(:response) { ShopifAi::Client.new.vector_stores.retrieve(id: vector_store_id) }
    ...
    describe "#create" do
      ...
      let(:response) do
        ShopifAi::Client.new.vector_stores.create(parameters: {})
      end
    ...
    describe "#modify" do
      ...
      let(:response) do
        ShopifAi::Client.new.vector_stores.modify(
          id: vector_store_id,
    ...
    describe "#delete" do
      ...
      let(:response) do
        ShopifAi::Client.new.vector_stores.delete(id: vector_store_id)
      end
    ...
    describe "#search" do
      ...
      let(:response) do
        ShopifAi::Client.new.vector_stores.search(
          id: vector_store_id,
          parameters: {
